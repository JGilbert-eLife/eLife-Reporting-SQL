...
echo "CREATE TABLE "initial_import" ("ms" INTEGER PRIMARY KEY,"initial_qc_dt" DATE,"initial_decision" TEXT,"initial_decision_dt" DATE,"appeal" INTEGER);" > /tmp/sql.cmds #
...
echo "CREATE TABLE "initial" ("ms" INTEGER PRIMARY KEY,"initial_qc_dt" DATE,"initial_decision" TEXT,"initial_decision_dt" DATE,"appeal" INTEGER);" >> /tmp/sql.cmds #
