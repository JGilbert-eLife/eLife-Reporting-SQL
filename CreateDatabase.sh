...
echo "CREATE TABLE "institution_import" ("ms" INTEGER PRIMARY KEY,"institution" TEXT);" >> /tmp/sql.cmds
echo "CREATE TABLE "institution_import_full" ("ms" INTEGER PRIMARY KEY,"institution" TEXT);" >> /tmp/sql.cmds
echo "CREATE TABLE "institution_import_other" ("ms" INTEGER PRIMARY KEY,"institution" TEXT);" >> /tmp/sql.cmds
...
echo "CREATE TABLE "institution" ("ms" INTEGER PRIMARY KEY,"institution" TEXT);" >> /tmp/sql.cmds
