...
for filename in $( ls /Users/GilbertJ/Documents/eLife_stats/stat_downloads/ ); do

case $filename in
	209.csv) #Initial Submission data
echo "DELETE FROM initial_import;" >> /tmp/sql.cmds
echo ".import /Users/GilbertJ/Documents/eLife_stats/stat_downloads/209.csv initial_import" >> /tmp/sql.cmds
...
echo ".import /Users/GilbertJ/Documents/eLife_stats/stat_downloads/210.csv full_import" >> /tmp/sql.cmds
...
echo ".import /Users/GilbertJ/Documents/eLife_stats/stat_downloads/211.csv rev1_import" >> /tmp/sql.cmds
...
echo ".import /Users/GilbertJ/Documents/eLife_stats/stat_downloads/212.csv rev2_import" >> /tmp/sql.cmds
...
echo ".import /Users/GilbertJ/Documents/eLife_stats/stat_downloads/213.csv rev3_import" >> /tmp/sql.cmds
...
echo ".import /Users/GilbertJ/Documents/eLife_stats/stat_downloads/214.csv rev4_import" >> /tmp/sql.cmds #
...
echo ".import /Users/GilbertJ/Documents/eLife_stats/stat_downloads/218.csv type_import" >> /tmp/sql.cmds #
